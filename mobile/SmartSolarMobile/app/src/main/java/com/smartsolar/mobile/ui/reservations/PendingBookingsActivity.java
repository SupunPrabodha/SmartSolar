...
public final class PendingBookingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.pendingBookingsRoot), (view, insets) -> {
    ...
    private void loadData(int page) {
        ...
        repository.getPendingBookings(query, (result, errorResource, httpStatusCode) -> {
