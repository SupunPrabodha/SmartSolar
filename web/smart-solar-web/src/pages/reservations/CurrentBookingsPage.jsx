    ...
    <div>
      <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
          ...
          <p className="text-secondary mb-0">Active reservations (Pending or Approved) with scheduled end times in the future. All times UTC.</p>
        </div>
      ...
      {loading ? (
        ...
        items.length > 0 ? (
          <>
            <ReservationTable items={items} caption="Current active energy reservations." />
          ...
          <section className="surface-card text-center py-5">
            ...
            <p className="text-secondary mb-0">There are no active reservations scheduled for current or future timeslots.</p>
          </section>
        )
      )}
    </div>
